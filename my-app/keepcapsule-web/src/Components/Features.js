    ...
    <section id="features" className="features">
      ...
      <div className="features-info">
        ...
        <p>
          ...
          Your capsule is always available — even if you don’t log in for years.
          We're building this to be timeless, private, and dependable.
        </p>
        ...
        <p>
          ...
          you’ll receive 5GB of secure storage for your memories. This will suit
          most users, and we’ll offer upgrade options soon if you need more
          space.
        </p>
